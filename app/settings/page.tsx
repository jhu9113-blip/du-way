...
import { Footprints, Accessibility, Zap, HandHelping, Minus, Plus, ArrowUpDown, ArrowUp, Route as RouteIcon, Ruler, FlaskConical } from 'lucide-react'
...
export default function SettingsPage() {
  ...
  return (
    <main className="flex flex-1 flex-col px-5 pt-8">
      <AppHeader title="설정" subtitle="이동 조건과 여유 시간을 조정하면 경로에 바로 반영돼요." />
      ...
      <section aria-labelledby="buffer-h" className="mb-6">
        ...
        <div className="flex items-center justify-between rounded-2xl border border-border bg-card p-4">
          <div>
            ...
            <p className="mt-0.5 text-sm text-muted-foreground">추천 출발 시각에 이만큼 여유를 더해요.</p>
          </div>
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex size-11 items-center justify-center rounded-xl border border-border bg-secondary text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
            >
